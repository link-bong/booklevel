...
INSERT INTO `addbooks` VALUES (1, 11);
...
INSERT INTO `bookmark` VALUES (10, 1, '2025-04-03 01:01:03');
...
INSERT INTO `books` VALUES (11, '战斗爽！', '连载中', '武侠', 6);
...
-- Records of browse
-- ----------------------------
INSERT INTO `browse` VALUES (1, 1, 1, '2025-04-09 20:53:14');
INSERT INTO `browse` VALUES (2, 1, 2, '2023-03-02 11:00:00');
INSERT INTO `browse` VALUES (3, 1, 3, '2025-04-08 22:14:00');
INSERT INTO `browse` VALUES (4, 1, 4, '2023-03-04 13:00:00');
INSERT INTO `browse` VALUES (5, 1, 5, '2025-04-09 17:23:15');
...
INSERT INTO `browse` VALUES (24, 1, 10, '2025-04-09 17:17:16');
INSERT INTO `browse` VALUES (25, 1, 8, '2025-04-08 23:35:07');
INSERT INTO `browse` VALUES (32, 1, 9, '2025-04-09 15:51:08');
INSERT INTO `browse` VALUES (35, 1, 6, '2025-04-09 17:05:37');
INSERT INTO `browse` VALUES (36, 1, 7, '2025-04-09 17:17:34');
INSERT INTO `browse` VALUES (37, 1, 11, '2025-04-09 20:52:17');
...
INSERT INTO `chapter` VALUES (16, '第一章 出生', 11);
...
INSERT INTO `comment` VALUES (41, '很好看，支持', '2025-04-09 16:06:27', 5, 1);
INSERT INTO `comment` VALUES (42, '棒！', '2025-04-09 16:08:33', 10, 1);
INSERT INTO `comment` VALUES (43, '1', '2025-04-09 16:55:38', 5, 1);

-- ----------------------------
-- Table structure for comment_backup
-- ----------------------------
DROP TABLE IF EXISTS `comment_backup`;
CREATE TABLE `comment_backup`  (
  `cm_id` int NOT NULL,
  `cm_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `cm_time` datetime NOT NULL,
  `b_id` int NOT NULL,
...
-- ----------------------------
-- Records of comment_backup
-- ----------------------------
INSERT INTO `comment_backup` VALUES (1, '更新后的评论内容', '2023-02-01 09:00:00', 1, 1);
INSERT INTO `comment_backup` VALUES (2, '情节跌宕起伏，非常吸引人。', '2023-02-02 10:00:00', 2, 1);
INSERT INTO `comment_backup` VALUES (3, '人物形象鲜明，让人印象深刻。', '2023-02-03 11:00:00', 3, 2);
INSERT INTO `comment_backup` VALUES (4, '文字优美，富有感染力。', '2023-02-04 12:00:00', 4, 2);
INSERT INTO `comment_backup` VALUES (5, '故事很感人，让人深思。', '2023-02-05 13:00:00', 5, 3);
INSERT INTO `comment_backup` VALUES (6, '对人性的描写很细腻。', '2023-02-06 14:00:00', 1, 3);
INSERT INTO `comment_backup` VALUES (7, '充满了生活的智慧。', '2023-02-07 15:00:00', 2, 4);
INSERT INTO `comment_backup` VALUES (8, '展现了时代的画卷。', '2023-02-08 16:00:00', 3, 4);
INSERT INTO `comment_backup` VALUES (9, '结构严谨，逻辑清晰。', '2023-02-09 17:00:00', 4, 5);
INSERT INTO `comment_backup` VALUES (10, '是一部经典之作。', '2023-02-10 18:00:00', 5, 5);
INSERT INTO `comment_backup` VALUES (11, '很有深度的作品。', '2023-02-11 09:30:00', 6, 1);
INSERT INTO `comment_backup` VALUES (12, '值得一读再读。', '2023-02-12 10:30:00', 7, 2);
INSERT INTO `comment_backup` VALUES (13, '触动人心的故事。', '2023-02-13 11:30:00', 8, 3);
INSERT INTO `comment_backup` VALUES (14, '精彩绝伦的描写。', '2023-02-14 12:30:00', 9, 4);
...
-- Records of reader
-- ----------------------------
INSERT INTO `reader` VALUES (1, '123', '123456');
...
INSERT INTO `reader` VALUES (12, '122', '666');
INSERT INTO `reader` VALUES (13, '2333', '123');
INSERT INTO `reader` VALUES (14, '1', '1');
...
INSERT INTO `wirter_reply` VALUES (16, 5, 41, '2025-04-09 16:09:17', '谢谢支持');
...
-- Records of writer
-- ----------------------------
INSERT INTO `writer` VALUES (6, 'pp', '321');
INSERT INTO `writer` VALUES (5, '沈从文', '123456');
